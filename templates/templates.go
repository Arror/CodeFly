...
func templatesSwiftServiceTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/swift/service.tpl", size: 176, mode: os.FileMode(420), modTime: time.Unix(1500947310, 0)}
